    ...
    return (
        <section id="contact" className="py-16 px-4 md:px-5 lg:px-6 relative overflow-hidden">
            ...
            <div className="center-container relative z-10">
                ...
                {/* عناصر عائمة للديكور */}
                <div className="absolute top-1/4 left-10 w-4 h-4 sm:w-6  sm:h-6 border-2 border-[#cc8e65] rounded-full floating-element opacity-20"
                    data-aos="fade-up"
                    data-aos-duration="1000"
                    data-aos-delay="700"></div>
                <div className="absolute bottom-1/3 right-20 w-2 h-2 sm:w-4  sm:h-4 border-2 border-[#FF6500] rounded-full floating-element opacity-20"
                    data-aos="fade-up"
                    data-aos-duration="1000"
                    data-aos-delay="800"></div>
                <div className="absolute top-1/5 right-40 w-4 h-4 sm:w-8 sm:h-8 border-2 border-[#FF6500] rounded-full floating-element opacity-20"
                    data-aos="fade-up"
                    data-aos-duration="1000"
                    data-aos-delay="900"></div>
                <div className="absolute top-1/10 left-1 w-4 h-4 sm:w-6  sm:h-6 border-2 border-[#dfb396] rounded-full floating-element opacity-20"
                    data-aos="fade-up"
                    data-aos-duration="1000"
                    data-aos-delay="700"></div>
                <div className="absolute bottom-1/10 right-20 w-2 h-2 sm:w-4  sm:h-4 border-2 border-[#dfb396] rounded-full floating-element opacity-20"
                    data-aos="fade-up"
                    data-aos-duration="1000"
                    data-aos-delay="800"></div>
                <div className="absolute top-1/5 right-40 w-4 h-4 sm:w-8  sm:h-8 border-2 border-[#dfb396] rounded-full floating-element opacity-20"
                    data-aos="fade-up"
                    data-aos-duration="1000"
                    data-aos-delay="900"></div>
                <div className="absolute top-1/12 left-1 w-4 h-4 sm:w-6  sm:h-6 border-2 border-[#cf8757] rounded-full floating-element opacity-20"
                    data-aos="fade-up"
                    data-aos-duration="1000"
                    data-aos-delay="700"></div>
                <div className="absolute bottom-1/8 right-20 w-2 h-2 sm:w-4  sm:h-4 border-2 border-[#FF6500] rounded-full floating-element opacity-20"
                    data-aos="fade-up"
                    data-aos-duration="1000"
                    data-aos-delay="800"></div>
                <div className="absolute top-1/1 right-40 w-4 h-4 sm:w-8  sm:h-8 border-2 border-[#dfb396] rounded-full floating-element opacity-20"
                    data-aos="fade-up"
                    data-aos-duration="1000"
                    data-aos-delay="900"></div>
            </div>
